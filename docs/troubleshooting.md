...
```bash
sqlite3 dev.db "select t.slug, s.native_products_forecast, s.native_products_warning, s.native_products_danger_map, s.native_products_station_map from settings s join tenants t on s.tenant_id = t.id order by t.slug;"
# expected: dvac|0|0|0|0  nwac|1|1|1|1  sac|0|0|0|1  snfac|1|1|1|1
```
