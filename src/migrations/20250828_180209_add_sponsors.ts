...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  `)
  await db.run(sql`CREATE INDEX \`sponsors_tenant_idx\` ON \`sponsors\` (\`tenant_id\`);`)
  ...
  await db.run(
    sql`ALTER TABLE \`_pages_v_rels\` ADD \`sponsors_id\` integer REFERENCES sponsors(id);`,
  )
  await db.run(
  ...
  await db.run(
    sql`ALTER TABLE \`payload_locked_documents_rels\` ADD \`sponsors_id\` integer REFERENCES sponsors(id);`,
  )
  await db.run(
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  `)
  await db.run(
    sql`INSERT INTO \`__new_pages_rels\`("id", "order", "parent_id", "path", "tags_id", "posts_id", "pages_id") SELECT "id", "order", "parent_id", "path", "tags_id", "posts_id", "pages_id" FROM \`pages_rels\`;`,
  )
  ...
  `)
  await db.run(
    sql`INSERT INTO \`__new__pages_v_rels\`("id", "order", "parent_id", "path", "tags_id", "posts_id", "pages_id") SELECT "id", "order", "parent_id", "path", "tags_id", "posts_id", "pages_id" FROM \`_pages_v_rels\`;`,
  )
  ...
  `)
  await db.run(
    sql`INSERT INTO \`__new_payload_locked_documents_rels\`("id", "order", "parent_id", "path", "media_id", "pages_id", "posts_id", "users_id", "tenants_id", "roles_id", "role_assignments_id", "global_roles_id", "global_role_assignments_id", "navigations_id", "biographies_id", "teams_id", "settings_id", "tags_id", "home_pages_id", "redirects_id", "forms_id", "form_submissions_id") SELECT "id", "order", "parent_id", "path", "media_id", "pages_id", "posts_id", "users_id", "tenants_id", "roles_id", "role_assignments_id", "global_roles_id", "global_role_assignments_id", "navigations_id", "biographies_id", "teams_id", "settings_id", "tags_id", "home_pages_id", "redirects_id", "forms_id", "form_submissions_id" FROM \`payload_locked_documents_rels\`;`,
  )
