# 20260923_031115_native_station_map_flag

## What caused these changes

`nativeProducts` on the `settings` collection gained a fifth per-tenant rollout checkbox, `stationMap`, for the native weather station map (#1221). Payload generated one statement: `ALTER TABLE settings ADD native_products_station_map integer DEFAULT false`.
