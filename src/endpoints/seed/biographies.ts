...
export const biographies: (
  ...
  for (let i = 0; i < biographies.length; i++) {
    ...
    if (name) {
      biographies[i].photo = images[name] || placeholders[(biographies[i].tenant as Tenant).slug]
      biographies[i].user = users[name]
    }
  }
  ...
  const teams: RequiredDataFromCollectionSlug<'teams'>[] = [
    {
      ...
      members: [
        bios["Dennis D'Amico"],
        bios['Dallas Glass'],
        bios['Andrew Harrington'],
        bios['Irene Henninger'],
        bios['Joe Dellaporta'],
        bios['Josh Hirshberg'],
        bios['Katie Warren'],
        bios['Lee Lazzara'],
    ...
    },
    {
      ...
      members: [bios['Roland Emetaz'], bios['Lewis Turner']],
    },
    ...
    },
    {
      tenant: tenants['snfac'],
      name: 'Non-Profit Staff',
      members: [bios['Hannah Marshall'], bios['Dawn Bird'], bios['Annie DeAngelo']],
    },
    {
      tenant: tenants['snfac'],
      name: 'Non-Profit Board of Directors',
      members: [
        bios['Ryan Guess'],
        bios['Travis Vandenburgh'],
        bios['Steve Butler'],
        bios['Erin Zell'],
        bios['Megan Stevenson'],
        bios['Tyler Ferris'],
        bios['Olin Glenne'],
        bios['Louise Stumph'],
      ],
...

    {
      tenant: tenants['sac'],
      name: 'Forecasters',
      members: [bios['Andy Anderson'], bios['Brandon Schwartz'], bios['Steve Reynaud']],
    },
    {
      tenant: tenants['sac'],
      name: 'Professional Observers',
      members: [bios['Travis Feist'], bios['David Reichel'], bios['Jason Bilek']],
    },
    {
      tenant: tenants['sac'],
      name: 'Non-Profit Staff',
      members: [bios['David Reichel'], bios['Travis Feist']],
    },
    {
      tenant: tenants['sac'],
      name: 'Non-Profit Board of Directors',
