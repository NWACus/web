...
> = {
  snfac: { forecast: true, warning: true, dangerMap: true, stationMap: false },
  nwac: { forecast: true, warning: true, dangerMap: true, stationMap: false },
  sac: { forecast: false, warning: false, dangerMap: false, stationMap: true },
}
