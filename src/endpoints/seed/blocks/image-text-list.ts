...
export const imageTextList = (image: Media): RequiredDataFromCollectionSlug<'pages'>['layout'] => {
  return [
    // 4 column layout
    {
      layout: 'above',
                  ...
                  children: [
                    {
                      ...
                      mode: 'normal',
                      style: '',
                      text: 'Four score hammock distillery, cloud bread fashion axe next level scenester. Portland meditation organic, la croix keytar waistcoat distillery vice disrupt hashtag fixie cray single-origin coffee PBR&B kitsch. Master cleanse kogi iceland Four score +1 hot chicken, hoodie intelligentsia. Four score literally praxis banjo dreamcatcher chartreuse, pork belly scenester JOMO tote bag hexagon next level put a bird on it bruh fashion axe. Man bun kogi bespoke farm-to-table scenester fixie edison bulb. Man braid Brooklyn crucifix grailed salvia yr poutine stumptown beard. Stumptown coloring book tonx Brooklyn helvetica YOLO bitters man braid williamsburg ramps.',
                      type: 'text',
                      version: 1,
                    },
                  ],
