...
/*
 * Vendored from shadcn, with one deviation: the selectable rows use `cursor-pointer` rather than
 * upstream's `cursor-default`. These read as buttons here, not as a native OS menu.
 */
