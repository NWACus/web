...
// False positive: Next.js only rejects two *named* dynamic siblings. This catch-all
// alongside `[slug]` is legal, and the named sibling wins for single-segment paths.
...
export default async function Page({ params: paramsPromise }: Args) {
  ...
  return (
    <>
      <Breadcrumbs center={center} path={fullPath} title={page.title} />
