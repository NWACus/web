...
import { ARCHIVE_DANGER_PATH } from '@/services/nac/forecastArchive'
...
export default async function Page({ params, searchParams }: ArchiveTabArgs) {
  ...
  const crumbs = { path: ARCHIVE_DANGER_PATH, title: TITLE, labels: ARCHIVE_TAB_BREADCRUMB_LABELS }
...
export const generateMetadata = archiveTabMetadata(TITLE, ARCHIVE_DANGER_PATH)
