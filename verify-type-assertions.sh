...
git grep -nrl 'eslint-disable-next-line @typescript-eslint/consistent-type-assertions' | grep -v "$( basename "${BASH_SOURCE[0]}" )" | sort --stable > "${repo_root}/consistent-type-assertions.txt"
